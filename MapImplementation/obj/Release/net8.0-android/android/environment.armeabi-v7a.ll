...
@dso_cache = dso_local local_unnamed_addr global [562 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 541416417, ; hash 0x20455be1, from name: MapImplementation
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1367561297, ; hash 0x51835451, from name: libaot-MapImplementation.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MapImplementation.dll.so
		ptr null; void* handle (0x0)
	}, ; 156
	...
	%struct.DSOCacheEntry {
		i64 1723687711, ; hash 0x66bd631f, from name: libaot-MapImplementation
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MapImplementation.dll.so
		ptr null; void* handle (0x0)
	}, ; 201
	...
	%struct.DSOCacheEntry {
		i64 2020698605, ; hash 0x787169ed, from name: aot-MapImplementation
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MapImplementation.dll.so
		ptr null; void* handle (0x0)
	}, ; 248
	...
	%struct.DSOCacheEntry {
		i64 2277924689, ; hash 0x87c65f51, from name: MapImplementation.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MapImplementation.dll.so
		ptr null; void* handle (0x0)
	}, ; 289
	...
	%struct.DSOCacheEntry {
		i64 3710325933, ; hash 0xdd2714ad, from name: aot-MapImplementation.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MapImplementation.dll.so
		ptr null; void* handle (0x0)
	}, ; 489
